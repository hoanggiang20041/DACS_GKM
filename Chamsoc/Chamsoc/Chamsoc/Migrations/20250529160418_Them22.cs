...
{
    /// <inheritdoc />
    public partial class Them22 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeniorName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SeniorPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasRated = table.Column<bool>(type: "bit", nullable: true),
                    HasComplained = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CareJobId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
